...
//984/43793/2.24/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MAX1771ESA+" (originalName "MAX1771ESA+")
	...
	(compDef "MAX1771ESA+" (originalName "MAX1771ESA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "EXT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "4" (pinName "SHDN") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "CS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "6" (pinName "AGND") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "5" (pinName "REF") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Input))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MAX1771ESA+"))
		...
		(attr "Manufacturer_Part_Number" "MAX1771ESA+")
		(attr "RS Part Number" "7328800P")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/7328800P")
		(attr "Arrow Part Number" "MAX1771ESA+")
		(attr "Arrow Price/Stock" "http://uk.rs-online.com/web/p/products/7328800P")
		(attr "Description" "High-Efficiency Step-Up DC-DC Controller")
		(attr "<Hyperlink>" "http://datasheets.maximintegrated.com/en/ds/MAX1771.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MAX1771ESA+.stp")
	)
